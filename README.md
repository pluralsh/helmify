# Helmify
[![CI](https://github.com/pluralsh/helmify/actions/workflows/ci.yml/badge.svg)](https://github.com/pluralsh/helmify/actions/workflows/ci.yml)
...
[![Go Report Card](https://goreportcard.com/badge/github.com/pluralsh/helmify)](https://goreportcard.com/report/github.com/pluralsh/helmify)
[![GoDoc](https://godoc.org/github.com/pluralsh/helmify?status.svg)](https://pkg.go.dev/github.com/pluralsh/helmify?tab=doc)
...
See [examples](https://github.com/pluralsh/helmify/tree/main/examples) of charts generated by helmify.
...
- With operator-sdk version < v1.23.0 
    ...
    helmify:
    	$(call go-get-tool,$(HELMIFY),github.com/pluralsh/helmify/cmd/helmify@v0.3.7)
...
- With operator-sdk version >= v1.23.0
    ...
    $(HELMIFY): $(LOCALBIN)
    	test -s $(LOCALBIN)/helmify || GOBIN=$(LOCALBIN) go install github.com/pluralsh/helmify/cmd/helmify@latest
...
Or download suitable for your system binary from [the Releases page](https://github.com/pluralsh/helmify/releases/latest).
